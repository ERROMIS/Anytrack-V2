...
class TrackerManager:
    ...
    def create_tracker(self, name: str, tracker_type: TrackerType, size: tuple[int, int] = (50, 50)) -> AbstractTracker:
        """
        ...
        tracker = tracker_type.value.constructor(name, tracker_size=size)
    ...
    def available_tracker_types() -> list[TrackerType]:
        return [v[1] for v in enumerate(TrackerType)]
