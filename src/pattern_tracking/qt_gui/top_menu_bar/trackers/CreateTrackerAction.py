...
from src.pattern_tracking.qt_gui.top_menu_bar.trackers.NewTrackerQDialog import NewTrackerQDialog
from src.pattern_tracking.logic.tracker import AbstractTracker
...
class CreateTrackerAction(QAction):
    ...
    def __init__(self, tracker_manager: TrackerManager,
                 gui_callback: Callable[[AbstractTracker.AbstractTracker], None],
