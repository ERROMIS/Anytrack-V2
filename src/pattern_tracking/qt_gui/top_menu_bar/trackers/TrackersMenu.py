...
from .EditActiveTrackerAction import EditActiveTrackerAction
...
class TrackersMenu(QMenu):
    ...
    def __init__(self, tracker_manager: TrackerManager, name: str = None, parent: QWidget = None):
        ...
        self._EDIT_TRACKER_ACTION = EditActiveTrackerAction(tracker_manager, parent=self)
        self.addAction(self._EDIT_TRACKER_ACTION)
        # menu parameters
